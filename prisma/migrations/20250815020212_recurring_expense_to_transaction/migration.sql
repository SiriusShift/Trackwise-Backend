...
-- Drop old RecurringExpense references
...
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_recurringId_fkey"
    FOREIGN KEY ("recurringId") REFERENCES "RecurringTransaction"("id")
...
ALTER TABLE "RecurringTransaction" ADD CONSTRAINT "RecurringTransaction_fromAssetId_fkey"
    FOREIGN KEY ("fromAssetId") REFERENCES "Asset"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "RecurringTransaction" ADD CONSTRAINT "RecurringTransaction_toAssetId_fkey"
    FOREIGN KEY ("toAssetId") REFERENCES "Asset"("id") ON DELETE SET NULL ON UPDATE CASCADE;